#!/usr/bin/env python3
"""
Comprehensive Backend API Testing for VyapaarSage_AI
...
class BharatBizAgentTester:
    def __init__(self, base_url="https://file-analyzer-91.preview.agent.com"):
    ...
    def run_all_tests(self):
        """Run all test suites"""
        print("🚀 Starting VyapaarSage_AI Backend API Tests...")
